<template>
    ...
    <div>
      ...
      <div class="b1">
         ...
         <div class="b2">
         <span style="font-size:16px">实付金额:</span><span style="font-size:14px">￥180</span>
         </div>
         <div class="b2">
         <span style="font-size:16px">付款时间:</span><span style="font-size:14px">2020-12-29 11:11</span>
         </div>
      </div>
          <div class="bo">
